...
public class NoLiabilityPage 
{
	...
	@FindBy(how= How.XPATH,using="//*[@id=\"iqwizardDiv\"]/iq-wizard/div/div[3]/div[1]/swiper/div[3]/div[2]/div[2]/div/div[1]/div/input")
	WebElement person_contact_details;
	...
	@FindBy(how= How.XPATH,using="//*[@id=\"iqwizardDiv\"]/iq-wizard/div/div[3]/div[1]/swiper/div[3]/div[2]/div[2]/div/input")
	WebElement similar_incident_details;
	@FindBy(how= How.XPATH,using="//*[@id='4524']")
	WebElement immediate_action_yes;
	@FindBy(how= How.XPATH,using="//*[@id=\"iqwizardDiv\"]/iq-wizard/div/div[3]/div[1]/swiper/div[3]/div[2]/div[2]/div/input")
	WebElement action_minimize_risk;
	...
	{
		waitForVisibility(questionVisibility);
		person_contact_details.sendKeys(contact);
	}
	...
	public void setSimilarIncidentDetails(String details)
	{
		waitForVisibility(questionVisibility);
		similar_incident_details.sendKeys(details);
	}
	public void selectImmediateAction()
	{
		actionClick(immediate_action_yes,questionVisibility);
	}
	public void setActionMinimizeRisk(String action)
	{
		action_minimize_risk.sendKeys(action);
	}
