...
public class TC_NoLiability extends BaseClass
{
	...
	public void addClaimFacts(String claimdate, String appid,String defname, String Cname,String csname,String refno) throws InterruptedException
	{
		...
		if(headerText.contains("Add claim details"))
		{
			...
			if(claimfactsHeader.contains("CLAIM FACTS") && successmsg)
			{
				...
				Thread.sleep(2000);
				//Q42
				NL.setSimilarIncidentDetails("test");
				Thread.sleep(4000);
				NL.navigateClaimFacts();
				Thread.sleep(2000);
				//Q43
				...
				Thread.sleep(2000);
				//Q44
				NL.setActionMinimizeRisk("action");
				Thread.sleep(4000);
				NL.navigateClaimFacts();
				Thread.sleep(2000);
				//Q45
	...
	String [][] getData() throws Exception
	{
		...
		{
			for(int j=0;j<cocount;j++) //Number o f columns
			{
